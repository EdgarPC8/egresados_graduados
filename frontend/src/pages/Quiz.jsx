        ...
        <Container py={2} maxW={"container.xl"} fontSize={"container.sm"}>
          ...
          <Grid p={2} border="1px solid #ccc" borderRadius={8} gap={4} mt={2}>
            <GridItem fontSize={"sm"}>
              <FormControl>
                <FormLabel>
                  ¿Cuál es la relación del trabajo que tiene con la carrera que
                  estudió?
                </FormLabel>
          ...
          >
            <GridItem fontSize={"sm"}>
              <FormControl>
                <FormLabel>
                  ¿Cuál fue el factor que más contribuyo para que consiguiera su
                  primer empleo?
                </FormLabel>
            ...
            <GridItem fontSize={"sm"}>
              <FormControl>
                <FormLabel>
                  ...
                  el desempeño de sus actividades laborales actuales? (Puede ser
                  más de uno)
                </FormLabel>
                <RadioGroup>
                  <Stack spacing={5}>
                    <Checkbox value={15} name="question14Option0">
                      Gestiona, transfiere y desarrolla soluciones informáticas
                      para ambientes corporativos
                    </Checkbox>
                    <Checkbox value={16} name="question14Option1">
                      Explora problemas y genera diseños y soluciones
                      inteligentes de sistemas informáticos mediante análisis de
                      tecnología y costos de software y hardware
                    </Checkbox>
                    ...
                    <Checkbox value={19} name="question14Option4">
                      Conoce los procedimientos de desarrollo, implementación y
                      adecuación de medios informáticos
                    </Checkbox>
                    ...
                    <Checkbox value={23} name="question14Option8">
                      Afronta y actúa con confianza y seguridad el análisis y la
                      solución de problemas que se encuentran en la profesión
                    </Checkbox>
          ...
          >
            <GridItem fontSize={"sm"}>
              <FormControl>
                <FormLabel>
                  En su opinión, ¿Cuáles son las principales carencias que tiene
                  el programa académico de la carrera en que se graduó?
                </FormLabel>
                <GridItem fontSize={"sm"}>
                  <FormControl>
          ...
          >
            <GridItem fontSize={"sm"}>
              <FormControl>
                <FormLabel>
                  ¿Que recomienda para estrechar las relaciones entre el ISTMS y
                  los GRADUADOS?
                </FormLabel>
                <GridItem fontSize={"sm"}>
                  <FormControl>
