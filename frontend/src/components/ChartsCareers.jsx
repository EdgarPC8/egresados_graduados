...
import { getProfesionalsCareers } from "../api/chartsResquest.js";
    ...
    try {
      ...
      data.forEach((student) => {
        ...
        if (student.gender === "F" || student.gender === "M") {
          ...
          countByCareers[student.career].genderCounts["Other"] =
            (countByCareers[student.career].genderCounts["Other"] || 0) + 1;
        }
      });
            ...
            <PieChart width={400} height={400}>
              ...
              >
                {ListGroupCareers &&
                  ListGroupCareers[0] &&
                  ListGroupCareers[0].length > 0 &&
                  ListGroupCareers[0].map((_, index) => (
                    <Cell
                      key={`cell-${index}`}
                ...
                {ListGroupCareers &&
                  ...
                  ListGroupCareers[1].map((entry, index) => (
                    <Cell
                      key={`cell-${index}`}
                      fill={
                        GENDER_COLORS[entry.name.charAt(entry.name.length - 1)]
                      }
                    />
                  ))}
              </Pie>
